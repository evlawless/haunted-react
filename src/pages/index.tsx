...
const TarotLink = ({title}:{title:string}) => {
	return (
		<Link href="#" className="">
		<div className="w-36 h-72 hover:w-40 hover:h-80  p-1 bg-amber-100 hover:shadow-xl hover:shadow-emerald-500">
			<div className="flex flex-col-reverse border border-black w-full h-full bg-gradient-to-br from-emerald-950 to-slate-950">
				...
				<div className="w-full h-full overflow-hidden">
					<Image alt="a random image" src={"https://picsum.photos/300/600"} width={300} height={600}/>
				</div>
			</div>
		</div>
		</Link>
...
const Home: NextPage = () => {
	...
	return (
		<>
			...
			<main className="flex min-h-screen flex-col items-center justify-center bg-rose-950">
